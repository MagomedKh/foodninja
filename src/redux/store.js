...
const loadState = () => {
    try {
        const serialisedState = JSON.parse(window.localStorage.getItem('foodNinjaStore'));
...
const store = createStore(rootReducer, oldState, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
