...
import { saveLogin, logout } from "../../redux/actions/user";
import {
    Alert,
    Button,
    Box,
...
const UserSettings = () => {
    ...
    sx={{ width: 1, mb: 4 }} />                     */}
                    ...
                    <FormControl sx={{ width: 1, mb: 4 }}>
                        ...
                        >
                            {!!user.dayBirthday ? (
                                ...
                                <>
                                    <div>Выберите ваш день рождения</div>
                                    <div>
                                        Указать дату можно только один раз
                                    </div>
                                </>
                            )}
                        </FormHelperText>
            ...
            <Dialog maxWidth="md" {...dialogProps} className="account-dialog">
