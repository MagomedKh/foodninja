                ...
                <div className="sales-wrapper">
                    ...
                    { sales.map( (sale, index) => 
                        <Grid item sm={12} md={4}>
                            <Card className="sale" onClick={() => handleSetActiveSale(sale)}>
                                <CardActionArea>
                                    <CardMedia
                                        component="img"
                                        image={sale.saleImg}
                                    ...
                                    <CardContent>
                                        ...
                                        <Typography variant="body2" >
                                            <div className="sale--short-content" dangerouslySetInnerHTML={{__html: sale.saleContent}}></div>
                                        </Typography>
                                    </CardContent>
                                </CardActionArea>
                            </Card>
                    ...
                    { activeSale && (
                        ...
                        >
                            ...
                            <div className="sale-modal">
                                ...
                                <img className="sale--img" src={activeSale.saleImg} alt={activeSale.saleTitle} />

                                <h2 className="sale-modal--title">{activeSale.saleTitle}</h2>

                                <div className="sale--content" dangerouslySetInnerHTML={{__html: activeSale.saleContent}}></div>
