...
export default function PromocodeMiniCartProduct({productCart, productCount, productTotalPrice}) {
        ...
        <div className="minicart--product" data-product_id={productCart.id}>
            <div className="minicart--product-info">
                ...
                <div className="minicart--product-inner">
                    ...
                    <a className="minicart--product-remove" onClick={handleRemovePromocodeProduct} data-product_id={productCart.id}>	
                        <CloseIcon />
                    </a>
                </div>
            </div>
            <div className="minicart--product-result">
                <span><span className="product--old-price">{parseInt(productCart.options._price).toLocaleString('ru-RU')} ₽</span> <span className="main-color">{parseInt(productTotalPrice).toLocaleString('ru-RU')} &#8381;</span></span>
