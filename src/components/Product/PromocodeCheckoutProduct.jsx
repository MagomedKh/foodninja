...
export default function PromocodeCheckoutProduct({productCart, productCount, productTotalPrice}) {
    ...
    return (
        <div className="checkout--product" data-product_id={productCart.id}>
            ...
            <div className="checkout--product-result">
                <span className="before-promocode-price">{productCart.options._price} &#8381;</span> <span className="main-color">{parseInt(productTotalPrice).toLocaleString('ru-RU')} &#8381;</span>
            </div>
        </div> 
    );
}
