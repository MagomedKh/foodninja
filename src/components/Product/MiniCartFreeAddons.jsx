...
export default function MiniCartFreeAddons() {
    ...
    return (
        <div>
            { countAddons ? (
            <div>
                <h4 className="minicart--free-addons-title">Бесплатные добавки</h4>
                <div className="minicart--product free-addon">
                    <div className="minicart--product-info">
                        ...
                        <div className="minicart--product-inner">
                            <div className="minicart--product-name">Соевый соус x <span className="count-free-addons">{countAddons} шт.</span></div>
                ...
                <div className="minicart--product free-addon">
                    <div className="minicart--product-info">
                        ...
                        <div className="minicart--product-inner">
                            <div className="minicart--product-name">Васаби x <span className="count-free-addons">{countAddons} шт.</span></div>
                            <span className="main-color">FREE</span>
                        </div>
                    </div>
                </div>             
                <div className="minicart--product free-addon">
                    <div className="minicart--product-info">
                        ...
                        <div className="minicart--product-inner">
                            <div className="minicart--product-name">Имбирь x <span className="count-free-addons">{countAddons} шт.</span></div>
                            <span className="main-color">FREE</span>
                        </div>
                    </div>
                </div> 
