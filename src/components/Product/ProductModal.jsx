   ...
   const productPriceRender = () => {
      if (activeVariant) {
         if (
            ...
            return <span>{activeVariant.price + modificatorsAmount} ₽</span>;
         }
      } else {
         if (
            ...
            return (
               <span>
                  {parseInt(productModal.options._price) + modificatorsAmount} ₽
               </span>
            );
         }
      }
               ...
               <div className="product-modal">
                  ...
                  <div className="product-modal--info">
                     <div className="product-modal--scrolling">
                        ...
                        {productModal.type === "variations" ? (
                           <>
                              ...
                              <div className="product-modal--attributes">
                                 {Object.values(productModal.attributes).map(
                                    (attribute, keyAttr) => (
                                       <div
                        ...
                        {productModal.product_addons?.map((category) => (
                           <ModificatorCategory
                              category={category}
                        ...
                        (config.CONFIG_addons_category_in_product ===
                           ...
                           productModal.product_addons.length) ? null : (
                              ...
                              <Grid container spacing={1} sx={{ mt: "6px" }}>
                                 {addon_products.map((product) => (
                                    <Grid
                                       ...
                                       key={product.id}
                                    >
                                       <AddonProductModal product={product} />
                                    </Grid>
                                 ))}
                              </Grid>
                           </div>
                     ...
                     <div className="product-modal--variations-buying">
                        <div className="product-modal--price-wrapper">
                           ...
                           <div className="product-modal--stats">
                              {productModal.type === "variations" ? (
                                 <>
                                    {activeVariant && activeVariant.weight ? (
                                 ...
                                 <>
                                    {productModal.options.weight ? (
                                       <div className="weight">
                                          {productModal.options.weight} гр.
                                       </div>
                                    ) : (
                                       ""
                                    )}
                                    {productModal.options.count_rolls ? (
                                       <div className="count-rolls">
                                          {productModal.options.count_rolls} шт.
                                       </div>
                                    ) : (
                                       ""
                                    )}
                        ...
                        {productModal.type === "variations" ? (
                           ...
                           <Button
                              ...
                              disabled={disabled || !modificatorsCondition}
                              data-product-id={productModal.id}
                           >
                              Хочу
                           </Button>
