        ...
        <div className="minicart--product" data-product_id={productCart.id}>
            <div className="minicart--product-info">
                ...
                <div className="minicart--product-inner">
                    ...
                    <a className="minicart--product-remove" onClick={handleRemoveProduct} data-product_id={productCart.id}>	
                        <CloseIcon />
                    </a>
                </div>
            </div>
            <div className="minicart--product-result">
                ...
                { ( promocodeProducts.id !== undefined && promocodeProducts.id === productCart.id ) ?
                    ( productCart.type === 'variations' && promocodeProducts.type === 'variations' && productCart.variant.variant_id == promocodeProducts.variant.variant_id && !productIndex ) ? <>
                        ...
                        : <span>{parseInt(productTotalPrice).toLocaleString('ru-RU')} &#8381;</span> }
